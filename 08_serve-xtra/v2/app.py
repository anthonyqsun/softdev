...
def disp_random_occ():
    ...
    s += f"<p>Your best bet is the <i> <a style = \"color: hsl({random.randrange(0,256)},90,56)\" href=\"https://www.google.com/search?q=how+to+apply+to+ {job.replace(" ","+")}\"> {job}</a></i> job </p>"
